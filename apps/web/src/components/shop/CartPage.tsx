    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="hover:text-primary cursor-pointer" onClick={() => router.push('/shop')}>Cửa hàng</span>
          <ChevronRight size={16} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {cartItems.length === 0 ? (
          ...
          >
            ...
            <p className="text-xl font-medium text-gray-600 mb-2">Giỏ hàng đang trống</p>
                      ...
                      >
                        ...
                        <div className="col-span-6 flex items-center gap-4 w-full">
                          ...
                          <div className="flex-1 pr-8 sm:pr-0">
                            <h3 className="font-medium text-gray-900 line-clamp-2 hover:text-primary cursor-pointer transition-colors" onClick={() => router.push(`/shop/product/${item._id}`)}>
                              {item.name}
                            </h3>
                        ...
                        {/* Desktop Price */}
                        <div className="hidden sm:block col-span-2 text-center font-medium text-gray-900">
                          {item.price.toLocaleString('vi-VN')} đ
                        </div>
                        ...
                        <div className="col-span-2 flex justify-center w-full sm:w-auto mt-4 sm:mt-0">
                          <div className="flex items-center bg-gray-50 rounded-lg border border-gray-200">
                            <motion.button 
                              ...
                              className="p-2 text-gray-600 hover:bg-gray-200 hover:text-gray-900 rounded-l-lg transition-colors disabled:opacity-50"
                            ...
                            <motion.button 
                              whileTap={{ scale: 0.9 }}
                              onClick={() => updateQuantity(item._id, item.quantity + 1)}
                              className="p-2 text-gray-600 hover:bg-gray-200 hover:text-gray-900 rounded-r-lg transition-colors"
                            >
                              <Plus size={14} />
                            </motion.button>
                          </div>
