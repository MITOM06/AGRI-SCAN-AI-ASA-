...
import { cn, IPlant } from "@agri-scan/shared";

// Extended interface for tree encyclopedia display
interface TreeDisplayData extends Omit<
  IPlant,
  "createdAt" | "updatedAt" | "diseases"
> {
  uses: string;
  care: string;
  category: string[];
...
const sampleTreeData: TreeDisplayData[] = [
  {
    id: "1",
    commonName: "Cây Bàng",
    scientificName: "Terminalia catappa",
    family: "Combretaceae",
    description: "Cây gỗ lớn, rụng lá về mùa khô. Tán lá xếp thành tầng.",
    images: [
      "https://cdn.eva.vn/upload/3-2021/images/2021-08-27/image3-1630030697-497-width600height400.jpg",
    ],
    uses: "Làm cây bóng mát, lấy gỗ, vỏ và lá có thể dùng làm thuốc.",
    ...
    soil: "Đất cát, đất thịt nhẹ",
    commonDiseases: "Sâu ăn lá, rệp sáp",
  },
  {
    id: "2",
    ...
    family: "Fabaceae",
    description: "Cây gỗ lớn, tán rộng. Hoa màu đỏ rực rỡ, nở vào mùa hè.",
    images: [
      "https://images.unsplash.com/photo-1560252538-40333d83d95f?q=80&w=800&auto=format&fit=crop",
    ],
    ...
    suitableLocation: "Trường học, đường phố",
    soil: "Đất giàu dinh dưỡng",
    commonDiseases: "Sâu đục thân, mối",
  },
];

export function TreeDictionary() {
  const [selectedTree, setSelectedTree] = useState<TreeDisplayData | null>(
    null,
  );
  ...
  const filteredTrees = useMemo(() => {
    return sampleTreeData.filter((tree) => {
      const matchesSearch =
    ...
    <div className="min-h-screen bg-gray-50 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24 max-h-[calc(100vh-8rem)] overflow-y-auto">
            ...
            <>
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 p-8 overflow-y-auto max-h-[60vh] md:max-h-[90vh]">
                    <motion.h2
