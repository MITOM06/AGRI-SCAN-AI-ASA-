...
export default function UserHomeScreen() {
  ...
  const handleLogout = () => {
    closeMenu();
    setTimeout(() => {
      // Logic đăng xuất ở đây (xóa token, v.v...)
      // Sau đó đẩy về trang chủ chưa đăng nhập hoặc trang login
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Thay thế nút Menu bằng Avatar User */}
        <TouchableOpacity
          onPress={openMenu}
        ...
        >
          <View style={styles.avatarCircleSmall}>
            <Text style={styles.avatarTextSmall}>CS</Text>
          </View>
        </TouchableOpacity>
      </View>
            ...
            >
              ...
              <View style={styles.userInfoSection}>
                <View style={styles.avatarCircleLarge}>
                  <Text style={styles.avatarTextLarge}>CS</Text>
                </View>
              ...
              {/* Footer: Đăng xuất thay vì Đăng nhập */}
              <View
                style={[
                  styles.menuFooter,
      ...
      {/* --- 3. Nội dung chính (Giữ nguyên như trang Home) --- */}
      <ScrollView
        showsVerticalScrollIndicator={false}
